...
nl (ff_d60 = {a_star} - {beta}*dsue_t1 - {beta_b_star}*dsue - {beta_c_star}*evol - {beta_d_star}*evol_dsue + {g}*size_t1 + {h}*size_t1_ds
...
capture preserve
sort company time
xtreg dsue_t1 $regvars1, fe
predict b_dsue_t1_model1, xb
predict se_dsue_t1_model1, stdp
gen beta_dsue_t1_model1 = b_dsue_t1_model1
gen stderr_dsue_t1_model1 = se_dsue_t1_model1
restore

* Step 2: Fama-Macbeth Regression using xtfmb
xtfmb dsue_t1 $regvars1, verbose lag(4)
est store m1
...
capture preserve
sort company time
xtreg dsue_t1 $regvars2, fe
predict b_dsue_t1_model2, xb
predict se_dsue_t1_model2, stdp
gen beta_dsue_t1_model2 = b_dsue_t1_model2
gen stderr_dsue_t1_model2 = se_dsue_t1_model2
restore

* Step 2: Fama-Macbeth Regression using xtfmb
xtfmb dsue_t1 $regvars2, verbose lag(4)
est store m2
